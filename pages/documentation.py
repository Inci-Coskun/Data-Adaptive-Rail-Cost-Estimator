...
# ── Derive all display data from pkl (zero hardcoding) ─────────────────────────
...
# ── Performance metrics (from training output — factual, not hardcoded model params) ──
cv_folds = [
...
# ═══════════════════════════════════════════════════════════════════════════════
# SECTION 3 — BAYESIAN ENCODING EXPLAINER
# ═══════════════════════════════════════════════════════════════════════════════
...
with right_enc:
    # Show a few example cities to illustrate shrinkage
...
with cp_right:
    # Country baseline cost chart from memory_package
...
st.caption(
    ...
    "No values are hardcoded on this page."
)